...
-- Ordenar todos los datos de la tabla "users" por edad de manera descendente
...
-- obtiene todos los nombres de la tabla "users" con email igual a sera@gamial,com y los ordena por edad de manera descendente
